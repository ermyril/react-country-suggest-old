...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__CountrySelect_js__ = __webpack_require__(13);
...
__WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.render(__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__CountrySelect_js__["a" /* default */]
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Dropdown_js__ = __webpack_require__(46);
...
var CancelToken = __WEBPACK_IMPORTED_MODULE_2_axios___default.a.CancelToken;
var cancel;
...
var CountrySelect = function (_React$Component) {
  ...
  function CountrySelect(props) {
    ...
    _this.state = {
      value: '',
      nameField: _this.props.nameField ? _this.props.nameField : 'name',
      flagField: _this.props.flagField ? _this.props.flagField : 'flag',
      apiURL: _this.props.apiURL ? _this.props.apiURL : 'https://restcountries.eu/rest/v2/name/',
      dropdownOpen: false,
      selectedItem: 0
    };
  ...
  _createClass(CountrySelect, [{
    key: 'fetchData',
    value: function fetchData(input) {
      var _this2 = this;

      if (cancel != undefined) {
        cancel();
      }
      return __WEBPACK_IMPORTED_MODULE_2_axios___default.a.get(this.state.apiURL + input, {
    ...
    key: 'fillData',
    value: function fillData(resData) {
      var data = [];
    ...
    value: function toggleDropdown() {
      ...
      setTimeout(function () {
        _this3.setState({ dropdownOpen: !_this3.state.dropdownOpen });
      }, 200);
    }
  }, {
    ...
    value: function handleNavigation(e) {
      if (!!this.state.data) {
        ...
        if (e.keyCode === 13 && !!this.state.data[this.state.selectedItem]) {
          ...
          var input = __WEBPACK_IMPORTED_MODULE_1_react_dom___default.a.findDOMNode(this.refs.input);
          input.blur();
        }
      }
    }
    ...
    value: function render() {
      ...
      if (this.state.dropdownOpen) {
        dropdown = __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__Dropdown_js__["a" /* default */], {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { onBlur: this.toggleDropdown, className: 'country-select' },
...
/* harmony default export */ __webpack_exports__["a"] = (CountrySelect);
...
var Dropdown = function (_React$Component) {
  ...
  _createClass(Dropdown, [{
    ...
    value: function renderRow(i) {
      ...
      var active = i === this.props.selectedItem ? 'active' : '';
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        { className: active, onClick: function onClick() {
            _this2.props.handleClick(i);
          }, key: i },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { src: this.props.data[i].flag }),
    ...
    key: 'render',
    value: function render() {
      var rows = this.renderRows(this.props.data);
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        'div',
        null,
        rows
